...
public class Admin_PatientMoreController implements Initializable {
    ...
    private void setPatientData(int id) {
        ...
        try {
            ...
            tf_search.textProperty().addListener((observable, oldValue, newValue) -> {
                filteredData.setPredicate(searchModule -> {
                    ...
                    if(Integer.toString(searchModule.getPatient_id()).toLowerCase().indexOf(searchKeyword) > -1) {
                        return true;
                    }
