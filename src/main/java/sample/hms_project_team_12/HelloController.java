...
public class HelloController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // Hide/Show Patient Register-view link
        ...
        button_login.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if(!tf_email.getText().trim().isEmpty() && !tf_password.getText().trim().isEmpty()){
                    Auth.userLogin(event,tf_email.getText(), tf_password.getText(), User.AccountType.valueOf(cb_account_type.getValue()));
        ...
        // onClick show Patient-self-register-view
