...
public class Doctor_PatientMoreController implements Initializable {
    ...
    // Set Patient ID
    public static void setPatient_id(int id) {
        patient_id = id;
    }
...
//                    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        btn_addRecord.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                MedicalRecord medicalRecord = new MedicalRecord();
                medicalRecord.createNewMedicalRecord(checkboxPopup.createMedicalRecordInPopUp(patient_id,doctor_id).getAcquire());
                // Reload Data from record
                getDataFromRecords();
            }
        });
